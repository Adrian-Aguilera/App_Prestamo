...
jQuery(function($) {
    ...
    // Simple phpmail text/plain > send_email_3.php 
    // PHPMailer text/html > phpmailer/send_email_3_phpmailer.php (default)
    ...
    $('form#wrapped').attr('action', 'phpmailer/send_email_3_phpmailer.php');
